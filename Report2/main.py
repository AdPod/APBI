...
from outer_circle import find_outer_radious
...
def crop(R, r, starting_point):
    ...
    img = Image.open(
        'C:/Users/tukan/Documents/SharedProjects/Biometria/APBI/Report2/images/eye.jpg')
    ...
    output.save('C:/Users/tukan/Documents/SharedProjects/Biometria/APBI/Report2/images/out-transparent.png')
    # below fix for .show(), which fails to show transparency
    bg = Image.new('RGB', output.size, (0, 0, 0))
    bg.paste(output, output)
    bg.show()
    bg.save(
        'C:/Users/tukan/Documents/SharedProjects/Biometria/APBI/Report2/images/out.png')


def main(args):
    # img = im_to_arr(args.img)
    img = im_to_arr('C:/Users/tukan/Documents/SharedProjects/Biometria/APBI/Report2/images/eye.jpg')
    ...
    R = find_outer_radious(img, center)

    crop(int(round(R)), int(round(r)), center)
